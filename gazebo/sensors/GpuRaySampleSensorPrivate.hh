 ...
 *
*/
#ifndef _GAZEBO_SENSORS_GPURAYSAMPLESENSOR_PRIVATE_HH_
#define _GAZEBO_SENSORS_GPURAYSAMMPLESENSOR_PRIVATE_HH_
...
namespace gazebo
{
  namespace sensors
  {
    ...
    class GpuRaySampleSensorPrivate : private GpuRaySensorPrivate
    {
#if 0
      ...
      public: rendering::GpuSampleLaserPtr laserCam;
#if 0
