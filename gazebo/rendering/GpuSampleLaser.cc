...
//////////////////////////////////////////////////
GpuSampleLaser::GpuSampleLaser(const std::string &_namePrefix, ScenePtr _scene,
                   const bool _autoRender)
  : GpuLaser::GpuLaser(_namePrefix, _scene, _autoRender)
...
//////////////////////////////////////////////////
GpuSampleLaser::~GpuSampleLaser()
{
  this->Fini();
}
#if 0
//////////////////////////////////////////////////
void GpuSampleLaser::Load(sdf::ElementPtr _sdf)
{
  Camera::Load(_sdf);
}

//////////////////////////////////////////////////
void GpuSampleLaser::Load()
{
  Camera::Load();
}

//////////////////////////////////////////////////
void GpuSampleLaser::Init()
{
  Camera::Init();
}

//////////////////////////////////////////////////
void GpuSampleLaser::Fini()
{
...
//////////////////////////////////////////////////
void GpuSampleLaser::CreateLaserTexture(const std::string &_textureName)
{
...
//////////////////////////////////////////////////
void GpuSampleLaser::PostRender()
{
  for (auto& [cubeFaceId, cubeFace] : this->dataPtr->cubeMapFaces)
  {
  ...
  constexpr unsigned int numberOfChannels = 3;
  ...
  if (this->newData && this->captureData)
  {
    ...
    const size_t laserBufferSize = this->dataPtr->horizontalRangeCount * this->dataPtr->verticalRangeCount * numberOfChannels;
    ...
    for (auto& [cubeFaceId, cubeFace] : this->dataPtr->cubeMapFaces)
    {
      cubeFace.depthImg.resize(depthImageBufferSize);

      Ogre::PixelBox dstBox(imageWidth, imageHeight, 1, Ogre::PF_FLOAT32_RGB, cubeFace.depthImg.data());
    ...
    for (unsigned int azimuthIndex = 0; azimuthIndex < this->dataPtr->horizontalRangeCount; ++azimuthIndex)
    {
      ...
      for (unsigned int elevationIndex = 0; elevationIndex < this->dataPtr->verticalRangeCount; ++elevationIndex)
      {
        ...
        GZ_ASSERT(depthImageBufferIndex + 2 < cubeFace.depthImg.size(), "Depth image buffer index is out of range");
        ...
        this->dataPtr->laserBuffer[laserBufferIndex] = cubeFace.depthImg[depthImageBufferIndex];
        this->dataPtr->laserBuffer[laserBufferIndex + 1] = cubeFace.depthImg[depthImageBufferIndex + 1];
        this->dataPtr->laserBuffer[laserBufferIndex + 2] = cubeFace.depthImg[depthImageBufferIndex + 2];
      }
    }
    IGN_PROFILE_END();
    ...
    this->dataPtr->newLaserFrame(
        ...
        this->dataPtr->verticalRangeCount, 3, "BLABLA");
  }
...
/////////////////////////////////////////////////
void GpuSampleLaser::UpdateRenderTarget(GpuLaserCubeFace &_cube_face)
{
...
/////////////////////////////////////////////////
void GpuSampleLaser::notifyRenderSingleObject(Ogre::Renderable *_rend,
...
//////////////////////////////////////////////////
void GpuSampleLaser::RenderImpl()
{
  IGN_PROFILE("rendering::GpuSampleLaser::RenderImpl");
  Ogre::SceneManager *sceneMgr = this->scene->OgreSceneManager();
...
//////////////////////////////////////////////////
GpuSampleLaser::DataIter GpuSampleLaser::LaserDataBegin() const
{
...
//////////////////////////////////////////////////
GpuSampleLaser::DataIter GpuSampleLaser::LaserDataEnd() const
{
...
//////////////////////////////////////////////////
void GpuSampleLaser::SetUpRenderTarget(GpuLaserCubeFace &_cube_face)
{
  Ogre::RenderTarget *renderTarget = _cube_face.texture->getBuffer()->getRenderTarget();
...
/////////////////////////////////////////////////
void GpuSampleLaser::SetRangeCount(const unsigned int _w, const unsigned int _h)
{
...
//////////////////////////////////////////////////
void GpuSampleLaser::SetHorzHalfAngle(const double _angle)
{
  this->horzHalfAngle = _angle;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetVertHalfAngle(const double _angle)
{
  this->vertHalfAngle = _angle;
}

//////////////////////////////////////////////////
double GpuSampleLaser::HorzHalfAngle() const
{
  return this->horzHalfAngle;
}

//////////////////////////////////////////////////
double GpuSampleLaser::VertHalfAngle() const
{
  return this->vertHalfAngle;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetIsHorizontal(const bool _horizontal)
{
  this->isHorizontal = _horizontal;
}

//////////////////////////////////////////////////
bool GpuSampleLaser::IsHorizontal() const
{
  return this->isHorizontal;
}

//////////////////////////////////////////////////
double GpuSampleLaser::HorzFOV() const
{
  return this->hfov;
}

//////////////////////////////////////////////////
double GpuSampleLaser::VertFOV() const
{
  return this->vfov;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetHorzFOV(const double _hfov)
{
  this->hfov = _hfov;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetVertFOV(const double _vfov)
{
  this->vfov = _vfov;
}

//////////////////////////////////////////////////
double GpuSampleLaser::CosHorzFOV() const
{
  return this->chfov;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetCosHorzFOV(const double _chfov)
{
  this->chfov = _chfov;
}

//////////////////////////////////////////////////
double GpuSampleLaser::CosVertFOV() const
{
  return this->cvfov;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetCosVertFOV(const double _cvfov)
{
  this->cvfov = _cvfov;
}

//////////////////////////////////////////////////
double GpuSampleLaser::NearClip() const
{
  return this->nearClip;
}

//////////////////////////////////////////////////
double GpuSampleLaser::FarClip() const
{
  return this->farClip;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetNearClip(const double _near)
{
  this->nearClip = _near;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetFarClip(const double _far)
{
  this->farClip = _far;
}

//////////////////////////////////////////////////
unsigned int GpuSampleLaser::CameraCount() const
{
  return this->cameraCount;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetCameraCount(const unsigned int _cameraCount)
{
  /*unused*/
}

//////////////////////////////////////////////////
double GpuSampleLaser::RayCountRatio() const
{
  return this->rayCountRatio;
}

//////////////////////////////////////////////////
void GpuSampleLaser::SetRayCountRatio(const double _rayCountRatio)
{
  this->rayCountRatio = _rayCountRatio;
}

//////////////////////////////////////////////////
event::ConnectionPtr GpuSampleLaser::ConnectNewLaserFrame(
...
//////////////////////////////////////////////////
void GpuSampleLaser::ApplyCameraSetting(const GpuLaserCameraOrientationOffset &_setting)
{
...
//////////////////////////////////////////////////
void GpuSampleLaser::RevertCameraSetting(const GpuLaserCameraOrientationOffset &_setting)
{
  this->sceneNode->yaw(Ogre::Radian(static_cast<float>(-_setting.elevationOffset)));
  this->sceneNode->roll(Ogre::Radian(static_cast<float>(-_setting.azimuthOffset)));
}
...
//////////////////////////////////////////////////
void GpuSampleLaser::InitMapping(const std::set<double> &_azimuth_values, const std::set<double> &_elevation_values)
{
  ...
  for (const double azimuth : _azimuth_values)
  {
    ...
    {
      const auto& [cube_face_id, face_coordinates] = GpuSampleLaser::FindCubeFaceMapping(azimuth - min_azimuth, elevation);
...
//////////////////////////////////////////////////
GpuLaserCubeMappingPoint GpuSampleLaser::FindCubeFaceMapping(const double _azimuth, const double _elevation)
{
  if (_azimuth < 0)
  {
  ...
  const GpuLaserCubeFaceId face_id = GpuSampleLaser::FindCubeFace(_azimuth, _elevation);
...
//////////////////////////////////////////////////
GpuLaserCubeFaceId GpuSampleLaser::FindCubeFace(const double _azimuth, const double _elevation)
{
  const ignition::math::Vector3d v = GpuSampleLaser::ViewingRay(_azimuth, _elevation);
...
//////////////////////////////////////////////////
ignition::math::Vector3d GpuSampleLaser::ViewingRay(const double _azimuth, const double _elevation)
{
